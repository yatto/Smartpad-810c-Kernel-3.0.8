...
#ifndef NT99250_X_OFFSET
#define NT99250_X_OFFSET 0
#endif

//#ifndef OV2655_BACK_X_OFFSET
//#define OV2655_BACK_X_OFFSET 2
//#endif
...
*v0.x.7 : 
*         1) this driver product resolution by IPP crop and scale, which user request but sensor can't support;
*         2) this driver and rk29_camera.c support upto 3 back-sensors and upto 3 front-sensors;
*/
#define RK29_CAM_VERSION_CODE KERNEL_VERSION(0, 1, 7)
...
static void rk29_camera_setup_format(struct soc_camera_device *icd, __u32 host_pixfmt, enum v4l2_mbus_pixelcode icd_code, struct v4l2_rect *rect)
{
	...
	if(strstr(dev_name(icd->pdev), RK29_CAM_SENSOR_NAME_NT99250))
		x_offset=NT99250_X_OFFSET;
//    else if(strstr(dev_name(icd->pdev), RK29_CAM_SENSOR_NAME_OV2655_BACK))
//        x_offset=OV2655_BACK_X_OFFSET;
    ...
    if (vip_ctrl_val & ONEFRAME)  {
        vip_crop = (((rect->left+x_offset)<<16) + rect->top);
        vip_fs  = (((rect->width + rect->left+x_offset)<<16) + (rect->height+rect->top));
