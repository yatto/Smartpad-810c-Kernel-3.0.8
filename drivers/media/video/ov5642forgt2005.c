...
#if defined OV5642_ORIENTATION_NORMAL
#define REG3818	0xc1
#define REG3621	0xc7
#elif defined OV5642_ORIENTATION_MIRROR
#define REG3818	0x81
#define REG3621	0xe7
#elif defined OV5642_ORIENTATION_FLIP
#define REG3818	0xe1
#define REG3621	0xc7
#else	//default, OV5642_ORIENTATION_MIRROR_FLIP
#define REG3818	0xa1
#define REG3621	0xe7
#endif

#ifndef OV5642_BP_REGULATOR
#define OV5642_BP_REGULATOR	0x2b
#endif
...
static struct reginfo sensor_init_data[] =
{
    ...
    {0x3a11 , 0x70},
    {0x3a1f , 0x10},
    {0x3030 , OV5642_BP_REGULATOR},//0x2b},//disable internal DVDD 1.5v
    {0x3a02 , 0x00},
    {0x3a03 , 0x7d},
    {0x3a04 , 0x00},
    {0x3a14 , 0x00},
...
static ssize_t ov5642_show(struct class *cls, char *_buf)
{
	return printk("%s()\n", __FUNCTION__);
}
...
static ssize_t ov5642_store(struct class *cls, const char *_buf, size_t _count)
{
	const char * p=_buf;
	u16 reg;
	u8 val;
...
static struct class *ov5642_class = NULL;
static CLASS_ATTR(ov5642, 0666, ov5642_show, ov5642_store);
			 ...
			 const struct i2c_device_id *did)
{
	...
	ov5642_class = class_create(THIS_MODULE, "ov5642");
	if (IS_ERR(ov5642_class)) 
	{
		printk("Create class ov5642.\n");
		return -ENOMEM;
	}
	class_create_file(ov5642_class,&class_attr_ov5642);
...
struct cam_sensor_info cam_sensor_info_ov5642forgt2005={
    "ov5642forgt2005",
    2,
    1,
    0x78>>1,
...
EXPORT_SYMBOL_GPL(cam_sensor_info_ov5642forgt2005);
