...
#define SENSOR_NAME ov2655_back
#define SENSOR_V4L2_IDENT_BACK V4L2_IDENT_OV2655_BACK
...
;
    ...
    id->ident = SENSOR_V4L2_IDENT_BACK;      /* ddl@rock-chips.com :  Return OV2655  identifier */
    id->revision = 0;
...
static struct class *ov2655_class_back = NULL;
static CLASS_ATTR(ov2655_back, 0666, ov2655_show, ov2655_store);
			 ...
			 const struct i2c_device_id *did)
{
	...
	ov2655_class_back = class_create(THIS_MODULE, "ov2655_back");
	if (IS_ERR(ov2655_class_back)) 
	{
		printk("Create class ov2655_back.\n");
		return -ENOMEM;
	}
	class_create_file(ov2655_class_back,&class_attr_ov2655_back);
...
struct cam_sensor_info cam_sensor_info_ov2655_back={
    "ov2655_back",
    2,
    1,
    0x60>>1,
...
EXPORT_SYMBOL_GPL(cam_sensor_info_ov2655_back);
