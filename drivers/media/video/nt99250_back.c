...
#define SENSOR_NAME nt99250_back
#define SENSOR_V4L2_IDENT_BACK V4L2_IDENT_NT99250_BACK
...
#ifndef NT99250_MIRROR_BACK
#define NT99250_MIRROR_BACK	0
#endif
#ifndef NT99250_FLIP_BACK
#define NT99250_FLIP_BACK	0
#endif

#ifndef VAL_306D_BACK
#define VAL_306D_BACK	0x01
#endif

#ifndef VAL_3069_BACK
#define VAL_3069_BACK	0x00
#endif

#ifndef VAL_306C_BACK
#define VAL_306C_BACK	0x00
#endif

#ifndef VAL_301E_BACK
...
{	{0x3021, 0x01},
	...
	{0x3069, VAL_3069_BACK}, 
	{0x306d, VAL_306D_BACK}, 
	{0x306c, VAL_306C_BACK}, 
	...
	{0x32e6, 0x00}, 
	{0x32e7, 0x00}, 
	{0x301e, VAL_301E_BACK}, 
	{0x301f, 0x20}, 
	{0x3022, (0x24 & ~(MASK_NT99250_ORIENT)) | (NT99250_MIRROR_BACK<<1) | (NT99250_FLIP_BACK<<0)}, 
	{0x3023, 0x64}, 
	{0x3002, 0x00}, 
	{0x3003, 0x04}, 
	{0x3004, 0x00}, 
 ...
 static int sensor_g_chip_ident(struct v4l2_subdev *sd, struct v4l2_dbg_chip_ident *id)
{
    ...
    id->ident = SENSOR_V4L2_IDENT_BACK;
    id->revision = 0;
...
static ssize_t nt99250_back_show(struct class *cls, char *_buf)
{
	return printk("%s()\n", __FUNCTION__);
}
...
static ssize_t nt99250_back_store(struct class *cls, const char *_buf, size_t _count)
{
	const char * p=_buf;
	u16 reg;
	u8 val;
...
static struct class *nt99250_back_class = NULL;
static CLASS_ATTR(nt99250_back, 0666, nt99250_back_show, nt99250_back_store);
			 ...
			 const struct i2c_device_id *did)
{
	...
	nt99250_back_class = class_create(THIS_MODULE, "nt99250_back");
	if (IS_ERR(nt99250_back_class)) 
	{
		printk("Create class nt99250_back.\n");
		return -ENOMEM;
	}
	class_create_file(nt99250_back_class,&class_attr_nt99250_back);
...
struct cam_sensor_info cam_sensor_info_nt99250_back={
    "nt99250_back",
    2,
    1,
    0x6c>>1,
...
EXPORT_SYMBOL_GPL(cam_sensor_info_nt99250_back);
